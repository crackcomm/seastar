...
constexpr std::string_view dh_level_key = "dh_level";
constexpr std::string_view x509_trust_key = "x509_trust";
constexpr std::string_view x509_crl_key = "x509_crl";
constexpr std::string_view x509_key_key = "x509_key";
constexpr std::string_view pkcs12_key = "pkcs12";
constexpr std::string_view system_trust = "system_trust";
